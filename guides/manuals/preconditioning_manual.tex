...
The second option allows you a choice of button to map preconditioning onto. More options will be available with the customized WiCAN (a replacement microcontroller shipping in October) in man-in-the-middle mode. By default, 5 options are displayed:
\begin{enumerate}
  \item Disabled
