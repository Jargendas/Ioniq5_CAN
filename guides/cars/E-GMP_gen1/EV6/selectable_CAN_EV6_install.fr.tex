...
\begin{abstract}
  Ce guide vous guide à travers les étapes nécessaires pour installer le faisceau CAN sélectionnable dans votre EV6 2021-2024. Voir aussi le \href{https://youtube.com/playlist?list=PLYCTmVJH4UYqnw87UZAaqMo1GrOv0cJaL}{guides vidéo}:
  \begin{description}
...
Ce guide décrit les étapes d'installation du faisceau CAN sélectionnable dans une ICU EV6. Voir aussi \href{https://github.com/dragz/explorationsincarhacking/blob/main/articles/getting_past_the_secure_gateway/getting_past_the_secure_gateway.md}{ces instructions} sur l'identification et l'accès au connecteur ICU-H. L'installation est très similaire à celle de l'Ioniq 5, et des photos d'un Ioniq 5 sont utilisées pour l'instant.
