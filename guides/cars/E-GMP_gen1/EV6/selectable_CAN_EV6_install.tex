...
This guide describes the steps to install the selectable CAN harness into an EV6 ICU. See also \href{https://github.com/dragz/explorationsincarhacking/blob/main/articles/getting_past_the_secure_gateway/getting_past_the_secure_gateway.md}{these instructions} on identifying and acessing the ICU-H connector. The install is very similar to the Ioniq 5 install, and photos of an Ioniq 5 are used for now.
