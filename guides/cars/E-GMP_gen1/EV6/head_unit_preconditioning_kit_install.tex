...
\begin{abstract}
  This is a placeholder; the EV6 guide will be available before shipping of your kit. See \href{https://github.com/tylerharvey/Ioniq5_CAN/blob/main/guides/cars/E-GMP_gen1/Ioniq5/head_unit_preconditioning_kit_install.pdf}{Ioniq 5 install instructions} for now to get a sense of the process.
